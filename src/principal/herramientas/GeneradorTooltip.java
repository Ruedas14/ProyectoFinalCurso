...
/**
 * para sacar un cuadrito que explique con informacion cuando tienes el raton encima
 */
public class GeneradorTooltip {
	...
	/**
	 * configurar la posicion y color de dicho cuadrito
	 * @param pi
	 * @return
	 */
	 ...
	 */
		...
		final Point posicionTooltipEscalada = EscaladorElementos.escalaPuntoAbajo(posicionTooltip);
		...
		switch(pistaPosicion){
			case "no":
				...
				break;
			case "ne":
				tooltip = new Rectangle(posicionTooltipEscalada.x - ancho, posicionTooltipEscalada.y, ancho + margenFuente 
						* 2, alto);
				break;
			case "so":
		...
		DibujoDebug.dibujarRectangleRelleno(g, tooltip, Color.black);
